    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      ...
      <main>
        ...
        <section className="relative h-[clamp(300px,46svh,440px)] md:h-[clamp(380px,52svh,540px)] flex items-center justify-center overflow-hidden border-b border-white/5">
          ...
          >
             <h3 className="text-primary font-black tracking-[0.18em] sm:tracking-[0.3em] md:tracking-[0.4em] uppercase mb-3 md:mb-4 text-[9px] sm:text-xs md:text-sm">Global Headquarters</h3>
             <h1 className="mx-auto text-[2rem] sm:text-4xl md:text-5xl lg:text-7xl font-black uppercase italic tracking-normal leading-[0.92] mb-5 md:mb-6 whitespace-nowrap">
             ...
             <div className="grid grid-cols-[minmax(16px,48px)_minmax(0,auto)_minmax(16px,48px)] items-center justify-center gap-2 sm:gap-4">
               ...
               <p className="max-w-[25ch] text-white font-bold uppercase tracking-[0.1em] sm:tracking-widest text-[9px] sm:text-xs leading-relaxed">Direct Manufacturing & Export Inquiries</p>
               <div className="h-[2px] w-full bg-primary" />
             </div>
          </motion.div>
        </section>
