        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-slate-600 dark:text-muted-foreground italic mb-6">Error: Unauthorized: No authorization header provided {"{ \"timestamp\": 1787294753138, \"error_type\": \"RUNTIME_ERROR\", \"filename\": \"http://localhost:8080/_serverFn/...\", \"stack\": \"Error: Unauthorized: No authorization header provided...\" }"} YE BHI FIX KRO</p>
              <div>
